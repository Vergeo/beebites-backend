...
export class PaymentController {
  ...
  @ApiOperation({ summary: "Get active payments by user" })
  @Get("get-active-payments/:userId")
  getActivePayments(@Param("userId") userId: string) {
    return this.paymentService.getActivePayments(+userId);
  }

  @ApiOperation({ summary: "Get payment history by user" })
  @Get("get-payment-history/:userId")
  ...
  @ApiOperation({ summary: "Get payment history with orders" })
  @Get("get-payment-history-with-orders/:userId")
  getPaymentHistoryWithOrders(@Param("userId") userId: string) {
    return this.paymentService.getPaymentHistoryWithOrders(+userId);
  }
}
